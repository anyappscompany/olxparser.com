...
$start_page_url = "https://profmaster.olx.ua/shop/";
...
$result = mysql_query("UPDATE products SET active=0");
...
$result = mysql_query("INSERT INTO updates (data, total, create_date) VALUES ('".mysql_real_escape_string(json_encode($goods, JSON_UNESCAPED_UNICODE))."', ".count($goods).", '".date("Y-m-d H:i:s")."')");
